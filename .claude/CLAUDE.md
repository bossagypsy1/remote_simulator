...
## IMPORTANT: Codebase Intelligence Instructions for remote_simulator
...
Last indexed: 2026-04-26 (commit b077054)
### Entry Points
- `src/cli/run.ts`
- `src/index.ts`
- `src/server/index.ts`
...
|------|-------|-------------|-------|
| `src/cli/run.ts` | 92.3th %ile | 5 | bossagypsy1 |
| `api/simulate.ts` | 84.6th %ile | 15 | bossagypsy1 |
| `src/payloads/mobile_phone.ts` | 76.9th %ile | 1 | bossagypsy1 |
